...
kubectl delete deployment customer-web --ignore-not-found=true
kubectl delete service customer-web --ignore-not-found=true
kubectl create -f ./build/deploy/k8s.yaml
